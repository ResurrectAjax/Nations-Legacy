...
public class GeneralMethods {
	 ...
	 * */
 	...
 	public static String formatPlaceholder(OfflinePlayer player, String value) {
 		String text = PlaceholderAPI.setPlaceholders(player, value);
	 ...
	 * */
 	...
 	public static String getBadSyntaxMessage(String syntax) {
 		return GeneralMethods.format(Main.getInstance().getLanguage().getString("Command.Error.BadSyntax.Message"), "%rel_nations_syntax%", syntax);
 	}
