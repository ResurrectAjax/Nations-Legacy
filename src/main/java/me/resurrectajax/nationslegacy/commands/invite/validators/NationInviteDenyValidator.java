...
public class NationInviteDenyValidator extends CommandValidator {

	public NationInviteDenyValidator(CommandSender sender, String[] args, ParentCommand command) {
