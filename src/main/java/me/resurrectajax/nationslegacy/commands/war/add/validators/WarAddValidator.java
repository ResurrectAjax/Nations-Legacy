package me.resurrectajax.nationslegacy.commands.war.add.validators;
...
public class WarAddValidator extends CommandValidator {

	public WarAddValidator(CommandSender sender, String[] args, ParentCommand command) {
