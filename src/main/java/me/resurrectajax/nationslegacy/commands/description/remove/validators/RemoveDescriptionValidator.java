package me.resurrectajax.nationslegacy.commands.description.remove.validators;
...
public class RemoveDescriptionValidator extends CommandValidator{

	public RemoveDescriptionValidator(CommandSender sender, String[] args, ParentCommand command) {
