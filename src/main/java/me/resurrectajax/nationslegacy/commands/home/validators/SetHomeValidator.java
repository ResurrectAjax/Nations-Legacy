...
public class SetHomeValidator extends CommandValidator{

	public SetHomeValidator(CommandSender sender, String[] args, ParentCommand command) {
	...
	public boolean validate() {
		...
		else if(nation.getHomes().size() >= maxHomes && args.length >= 2) player.sendMessage(GeneralMethods.format((OfflinePlayer)sender, language.getString("Command.Nations.Home.SetHome.MaxHomes.Message"), nation.getName()));
		else return true;
		return false;
	}
