package me.resurrectajax.nationslegacy.commands.alliance.remove.validators;
...
public class AllyRemoveValidator extends CommandValidator {

	public AllyRemoveValidator(Nations main, CommandSender sender, String[] args, AllyRemove command) {
